...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-hospital-management-key')
...
if DB_ENGINE == 'django.db.backends.sqlite3':
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.environ.get('DB_PASSWORD', 'hospital_pass'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Production-grade API for managing patients, doctors, appointments, medical records, prescriptions, medicine inventory, billing, and dashboards.',
    'VERSION': '1.0.0',
